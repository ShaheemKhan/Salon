...
// Starts a connection to download the current URL.
{
    ...
    NSString *s = [NSString stringWithFormat: @"http://localhost:8080/social/comment?id=%@&text=%@", [[detailItem primaryID] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],[[titleField text] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
    NSLog(@"%@", s);
