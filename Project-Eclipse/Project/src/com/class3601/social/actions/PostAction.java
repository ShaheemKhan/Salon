...
public class PostAction extends ActionSupport implements ServletRequestAware {
    ...
    private static String PARAMETER_1 = "title";
    private static String PARAMETER_2 = "by";
	...
	public String execute() throws Exception {
		...
		Post p = new Post();
		p.setTitle(parameter1);
		p.setAuthor(parameter2);
		manager.add(p);
		return "success";
	}
