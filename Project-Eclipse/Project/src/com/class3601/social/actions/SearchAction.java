...
public class SearchAction extends ActionSupport implements ServletRequestAware {
    private static String PARAMETER_1 = "query";
    private static String PARAMETER_2 = "start";
    private static String PARAMETER_3 = "end";
	...
	public String execute() throws Exception {
		...
		List<Post> l = manager.search(parameter1, from, to);
		...
		for (int x = 0; x < l.size(); x++) {
			...
			messageStore.appendToMessage(l.get(x).getCommentList().size() + "");
